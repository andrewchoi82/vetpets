...
export default function dashboardAppointmentsBox() {
    ...
    return (
        <div className="flex flex-col w-[524px] h-72 bg-white rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.10)] p-6 gap-6">
            ...
            <div className="flex w-[524px] -mx-6">
                ...
                <div className="h-16 bg-zinc-100 px-4 flex-1">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-black text-lg">{appointmentData?.name}</div>
                    </div>
                </div>
            </div>
