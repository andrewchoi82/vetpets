    ...
    <main className="p-[5px] md:p-[50px] h-full bg-[#F9F9F9]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Pet Info */}
          <div className="bg-white rounded-xl shadow-md p-5 flex flex-col max-h-72 h-72 w-[calc(100%+12px)] -ml-6">
            <div className="mt-4 space-y-4 w-full">
              <div className="flex items-center">
                ...
                />
                <span className="text-Text-Main text-base font-medium leading-loose">Age:</span>
                <span className="text-Text-Main text-base font-normal leading-loose ml-1">{pet?.age || "N/A"}</span>
              </div>
              <div className="flex items-center">
                <Image
                  ...
                  className="w-5 h-5 mr-6"
                />
                <span className="text-Text-Main text-base font-medium leading-loose">Gender:</span>
                <span className="text-Text-Main text-base font-normal leading-loose ml-1">{pet?.sex || "N/A"}</span>
              </div>
              <div className="flex items-center">
                <Image
                  ...
                  className="w-5 h-5 mr-6"
                />
                <span className="text-Text-Main text-base font-medium leading-loose">Weight:</span>
                <span className="text-Text-Main text-base font-normal leading-loose ml-1">{pet?.weight || "N/A"}</span>
              </div>
              <div className="flex items-center">
                <Image
                  ...
                  className="w-5 h-5 mr-6"
                />
                <span className="text-Text-Main text-base font-medium leading-loose">Breed:</span>
                <span className="text-Text-Main text-base font-normal leading-loose ml-1">{pet?.breed || "N/A"}</span>
              </div>
              <div className="flex items-center">
                <Image
                  ...
                  className="w-5 h-5 mr-6"
                />
                <span className="text-Text-Main text-base font-medium leading-loose">Sterilized:</span>
                <span className="text-Text-Main text-base font-normal leading-loose ml-1">{pet?.sterilized || "N/A"}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-4 max-h-72 h-72">
