   ...
   return (
       <div style={{ display: "flex", height: "100vh", overflow: "hidden" }}>
         ...
         <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "#fff", overflowY: "auto" }}>
            ...
            <BasicInfoContainer style={{marginTop: "20px", marginLeft: "20px"}} profileImg="/img/header/doge.png" fullName="Jane Doe" birthday="Janurary 01, 2000" sex="Female"></BasicInfoContainer>
