...
export async function POST(req: NextRequest) {
  try {
    ...
    await axios.post(
      ...
      {
        role: 'user',
        content: 'Please analyze this veterinary lab report and return an HTML <div> component styled with Tailwind that includes a table with: Test Name, Result, Reference Range, Explanation. Explain values in plain English.',
        attachments: [{
            file_id: fileId,
